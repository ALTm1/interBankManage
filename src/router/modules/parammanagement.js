...
export default [
  {
    ...
    redirect: { name: 'productService' },
    component: () => import('@/views/parammanagement/paramsManagement.vue'),
    children: [
      {
        path: '/productService',
        name: 'productService',
      ...
      {
        path: '/sectionModifyConf',
        name: 'sectionModifyConf',
        meta: {
          title: '部门修改确认'
        },
        component: () => import('@/views/parammanagement/sectionservice/sectionModifyConf.vue'),

      },
      {
        path: '/sectionModifyRes',
        name: 'sectionModifyRes',
        meta: {
          title: '部门修改结果'
        },
        component: () => import('@/views/parammanagement/sectionservice/sectionModifyRes.vue'),
