    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: 'addconfirm',
                name: 'addconfirm',
                component: () => import('@/pages/system/role/addConfirm.vue'),
                meta: {
                    title: '新增确认页'
                } 
            },
            {
                path: 'addresult',
                name: 'addresult',
                component: () => import('@/pages/system/role/addResult.vue'),
                meta: {
                    title: '新增结果页'
                } 
            },
            {
                path: 'rolecancel',
                name: 'rolecancel',
                component: () => import('@/pages/system/role/roleCancel.vue'),
                meta: {
                    title: '角色注销页'
                } 
            },
            {
                path: 'cancelresult',
                name: 'cancelresult',
                component: () => import('@/pages/system/role/cancelResult.vue'),
                meta: {
                    title: '注销结果页'
                } 
            },
