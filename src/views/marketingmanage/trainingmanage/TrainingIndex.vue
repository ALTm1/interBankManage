 ...
 * @LastEditTime: 2020-08-04 13:24:45
...
<template>
  <div>
    ...
    <div class="table-wrap" v-if="showTable">
      ...
      <div class="buttons" style="paddingTop: 40px" v-if="showTable">
...
export default {
  ...
  methods: {
    ...
    goTrainingIncrease() {
      this.$router.push('/marketingmanage/trainingmanage/trainingincrease')
    },
  },
}
</script>
