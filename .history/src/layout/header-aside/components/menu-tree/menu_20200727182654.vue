    ...
    <div class="menu-wrap">
      ...
      <ui-menu default-active="1" class="el-menu-vertical-demo" @open="handleOpen">
        ...
        <ui-submenu index="7">
          ...
          <ui-menu-item index="7-1">会议管理</ui-menu-item>
          <ui-menu-item index="7-2">培训管理</ui-menu-item>
          <ui-menu-item index="7-3">机构动态管理</ui-menu-item>
          <ui-menu-item index="7-4">营销展示管理</ui-menu-item>
        </ui-submenu>
