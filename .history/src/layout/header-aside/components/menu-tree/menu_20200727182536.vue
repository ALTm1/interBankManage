  ...
  <div class="menu-list">
   <div class="menu-wrap">
        ...
        <ui-submenu index="6">
            ...
            <ui-menu-item index="5-1">会议管理</ui-menu-item>
            <ui-menu-item index="5-2">培训管理</ui-menu-item>
            <ui-menu-item index="5-3">授信文件管理</ui-menu-item>
            <ui-menu-item index="5-4">授信文件管理</ui-menu-item>
          </ui-submenu>
