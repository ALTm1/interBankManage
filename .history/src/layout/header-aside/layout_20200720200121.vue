    ...
    <div class="menu-side">
      <div class="menu-wrap">
        ...
        >
         ...
         <ui-submenu index="2" @click="system">
            <template slot="title">
              <i class="el-icon-location"></i>
              <span>系统管理</span>
            </template>
            <ui-menu-item index="2-1">操作员管理</ui-menu-item>
            <ui-menu-item index="2-2">角色管理</ui-menu-item>
            <ui-menu-item index="2-3">选项2</ui-menu-item>
            <ui-menu-item index="2-4">选项2</ui-menu-item>
          </ui-submenu>
