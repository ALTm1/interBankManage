  ...
  <div class="operate-wrap">
    ...
    <div class="operate-header">
      <ui-breadcrumb separator-class="ui-icon-arrow-right">
        ...
        <ui-breadcrumb-item>登录密码重置</ui-breadcrumb-item>
      </ui-breadcrumb>
    </div>
    <!-- 操作员管理 -->
    <div class="operate-content">
      ...
      <div class="operate-manage" v-show="showQuery">
        ...
        <ui-table :data="tableData" cell-class-name="number">
          ...
          <ui-table-column prop="phone" label="联系电话" width="150"></ui-table-column>
          <ui-table-column prop="department" label="所属部门" width="120"></ui-table-column>
          <ui-table-column prop="role" label="操作员角色" width="120"></ui-table-column>
          <ui-table-column prop="time" label="创建时间" width="150"></ui-table-column>
          <ui-table-column fixed="right" label="操作" width="100">
            <template slot-scope="scope">
              <ui-button @click="reset(scope.row)" type="text" size="small">密码重置</ui-button>
...
export default {
  ...
  methods: {
    ...
    add() {
      // 新增，跳转到新增录入页
      this.$router.push("system/operateAdd");
    }
  }
};
</script>
