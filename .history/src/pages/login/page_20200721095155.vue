            ...
            <div class="login-content">
              ...
              >
                <ui-form-item prop="username">
                  <ul>用户名</ul>
                  <ui-input type="text" v-model="formLogin.username"
                    :placeholder="$t('login.form.placeholder.username')"></ui-input>
                </ui-form-item>
                ...
                <div class="login-btn">
                  ...
                  type="primary"
                  class="button-login"
                >{{ $t('login.form.button.login') }}</ui-button>
                </div>
        ...
        username: [
          {
            ...
            message: this.$t("public.rules.required", {
              name: this.$t("login.form.label.username")
            }),
            trigger: "blur"
          }
        ],
        password: [
          {
            required: true,
            message: this.$t("public.rules.required", {
              name: this.$t("login.form.label.password")
            }),
            trigger: "blur"
          }
        ]
