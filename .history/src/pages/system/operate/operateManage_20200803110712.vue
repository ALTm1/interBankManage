    ...
    <div class="operate-content">
      ...
      <div class="operate-manage">
        ...
        <ui-table :data="tableData">
          <ui-table-column prop="number" label="机构号" width="100"></ui-table-column>
          <ui-table-column prop="name" label="操作员姓名" width="150"></ui-table-column>
          <ui-table-column prop="department" label="所属部门" width="150"></ui-table-column>
          ...
          <ui-table-column prop="time" label="上次登录时间" width="150"></ui-table-column>
         <ui-table-column
      fixed="right"
      label="更多"
      width="180">
