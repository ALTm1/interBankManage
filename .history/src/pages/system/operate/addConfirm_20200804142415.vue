<template>
    ...
    <!-- <div class="operate-header">
      <ui-breadcrumb separator-class="ui-icon-arrow-right">
        ...
        <ui-breadcrumb-item>新增确认页</ui-breadcrumb-item>
      </ui-breadcrumb>
    </div> -->
    <div class="detail-content">
        <div class="table-title">
          <li class="title-left">操作员新增确认页</li>
...
export default {
    ...
    data(){
        return{
            ...
            estime:"2020-09-09  19:00",
            role:"交易员",
            state:'正常',
            department:'金融同业部',
            orgnization:'江南农商银行总行',
            email:'128739812@jdf.cn',
            phone:'18888888888',
            number:'11100',
            znumber:'12345678909876543',
            name:'张三',
            id:'11100'
        }
    },
...
.content-left li:nth-child(2),.content-right li:nth-child(2){
    width:300px;
height:33px;
line-height: 33px;
...
.content-left li:nth-child(1),.content-right li:nth-child(1){
    text-align: right;
    width: 150px;
}
.content-wrap{
