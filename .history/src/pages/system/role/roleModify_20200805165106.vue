      ...
      <div class="content-wrap">
        ...
        <div>
          ...
          <ul class="content-right">
            ...
            <input type="text" name id v-model="ps" />
          </ul>
        </div>
        <div class="role-function">
        <li>关联功能：</li>
        <ul class="function-tree">
          <ui-tree
            :data="data"
            show-checkbox
            node-key="id"
...
export default {
  ...
  created(){
    ...
    this.name=this.$route.params.ps;
    this.id=this.$route.params.ps;
  },
  methods: {
    confirm() {
