    ...
    <div class="operate-content">
      ...
      <div class="operate-table">
        ...
        <div class="table-wrap">
          ...
          <ul>
            <li>起始日期</li>
            <ui-date-picker v-model="value1" type="date" placeholder="请选择起始日期"></ui-date-picker>
          </ul>
          <ul>
            <li>终止日期</li>
            <ui-date-picker v-model="value2" type="date" placeholder="请选择终止日期"></ui-date-picker>
          </ul>
        </div>
        <div class="table-btn">
      ...
      <div class="operate-manage" v-show="showQuery">
        ...
        <ui-table :data="tableData" cell-class-name="number">
          ...
          <ui-table-column prop="id" label="操作员ID" width="180"></ui-table-column>
          <ui-table-column prop="name" label="操作员姓名" width="180"></ui-table-column>
          <ui-table-column prop="department" label="从属机构" width="180"></ui-table-column>
